...
const String mock_user = "INSERT INTO " + DB_USER + "(id, created_ms, number, email, adgj, lang) VALUES ";
const List<String> mock_insertUser = [
  "1, 1589781378419, '027 123456789', '123@abc.com', '123asd', 'en'",
];

const String mock_group = "INSERT INTO " + DB_GROUP + "(id, created_ms, name, public_key, private_key) VALUES ";
const List<String> mock_insertGroup = [
  "1, 1589781378419, 'Me', '-----BEGIN PUBLIC KEY----------END PUBLIC KEY-----',"
  ...
  "2, 1589781378419, 'Group 1','',''",
  "3, 1589781378419, 'Group 2','',''",
  "4, 1589781378419, 'Group 3','',''",
];

const String mock_userGroup = "INSERT INTO " + DBJ_USER_GROUP + "(id, created_ms, " + DBK_USER + ", " + DBK_GROUP + ", admin) VALUES ";
const List<String> mock_insertUserGroup = [
  "1, 1589781378419, 1, 1, 1",
  "2, 1589781378419, 1, 2, 0",
];

const String mock_graph = "INSERT INTO " + DB_GRAPH + "(id, created_ms, " + DBK_GROUP + ", graph) VALUES ";
const List<String> mock_insertGraph = [
  "1, 1589781378419, 1, '0.55,0.52,0.495,0.465,0.525,0.525,0.535,0.465,0.525,0.485,0.49,0.565,0.56'",
//  "2, 1, 'Graph 2'",
//  "3, 1, 'Graph 3'",
//  "4, 1, 'Graph 4'",
//  "5, 1, 'Graph 5'",
...
const String mock_comment = "INSERT INTO " + DB_COMMENT + "(id, created_ms, " + DBK_GROUP + ", " + DBK_GRAPH + ", " + DBK_USER + ", comment) VALUES ";
