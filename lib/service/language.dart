...
List<LangLabel> _en = [
  ...
  LangLabel('GraphSubTitle', 'Average of 200 Random 1\'s or 0\'s per Trial'),
  LangLabel('GraphX', 'Trials'),
  LangLabel('GraphY', 'Trial Average'),
  LangLabel('Highlight', 'Highlight'),
  ...
  LangLabel('DelGraphC', 'Can\'t Delete Graph'),
  LangLabel('DelGraphQ', 'Are you sure you want to delete the graph?'),
  LangLabel('DelGraphHL', 'The graph has been highlighted, so can\'t delete. Uncheck the Highlight checkbox first.'),
